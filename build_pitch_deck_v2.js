...
// ==========================================
// SLIDE 2: THE PROBLEM (FIXED: moved cards up, smaller spacing)
// ==========================================
slide = pres.addSlide();
...
solutions.forEach(([title, desc], i) => {
  ...
  slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
    x: col, y: row, w: 4.0, h: 1.65, fill: { color: C.lightGray }, rectRadius: 0.08,
    shadow: makeShadow()
  });
  slide.addText(title, {
    x: col + 0.3, y: row + 0.2, w: 3.4, h: 0.4,
    fontSize: 14, fontFace: "Calibri", bold: true, color: C.green
  });
  slide.addText(desc, {
    x: col + 0.3, y: row + 0.6, w: 3.4, h: 0.9,
...
techStack.forEach(([name, desc], i) => {
  ...
  slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
    x: col, y: row, w: 4.2, h: 0.95, fill: { color: "1E3A5F" }, rectRadius: 0.05
  });
  slide.addText(name, {
    x: col + 0.3, y: row + 0.1, w: 3.6, h: 0.4,
    fontSize: 13, fontFace: "Calibri", bold: true, color: C.gold
  });
  slide.addText(desc, {
    x: col + 0.3, y: row + 0.48, w: 3.6, h: 0.38,
...
// ==========================================
// SLIDE 6: LOCATION (FIXED: tightened vertical spacing)
// ==========================================
slide = pres.addSlide();
slide.background = { color: C.white };
...
// ==========================================
// SLIDE 7: PHASED APPROACH (FIXED: removed bottom text, moved into cards)
// ==========================================
slide = pres.addSlide();
slide.background = { color: C.cream };
...
slide.addText("Risk is minimized: small investment, founder maintains income, expand only after demand is proven.", {
  x: 0.8, y: 0.95, w: 8.4, h: 0.35, fontSize: 11, fontFace: "Calibri", italic: true, color: C.gray
});

// Phase 1 card
slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
  x: 0.8, y: 1.5, w: 4.0, h: 3.6, fill: { color: C.white }, rectRadius: 0.08, shadow: makeShadow()
});
slide.addText("PHASE 1", {
  x: 1.1, y: 1.7, w: 3.4, h: 0.4, fontSize: 16, fontFace: "Calibri", bold: true, color: C.green
});
slide.addText("Year 1 — Validate", {
  x: 1.1, y: 2.1, w: 3.4, h: 0.3, fontSize: 12, fontFace: "Calibri", color: C.gray
});
slide.addText([
...
// Phase 2 card
slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
  x: 5.2, y: 1.5, w: 4.0, h: 3.6, fill: { color: C.white }, rectRadius: 0.08, shadow: makeShadow()
});
slide.addText("PHASE 2", {
  x: 5.5, y: 1.7, w: 3.4, h: 0.4, fontSize: 16, fontFace: "Calibri", bold: true, color: C.green
});
slide.addText("Year 3 — Scale", {
  x: 5.5, y: 2.1, w: 3.4, h: 0.3, fontSize: 12, fontFace: "Calibri", color: C.gray
});
slide.addText([
...
metrics.forEach(([num, label, sub], i) => {
  const col = i * 2.3 + 0.8;
  slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
    x: col, y: 1.2, w: 2.1, h: 1.8, fill: { color: i === 3 ? C.navy : C.lightGray }, rectRadius: 0.06, shadow: makeShadow()
  });
  slide.addText(num, {
...
slide.addChart(pres.charts.BAR, [
  ...
  x: 0.8, y: 3.2, w: 8.4, h: 2.1, barDir: "col",
...
// ==========================================
// SLIDE 9: THE ASK (FIXED: tighter layout)
// ==========================================
slide = pres.addSlide();
slide.background = { color: C.navy };
...
slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
  x: 0.8, y: 1.2, w: 8.4, h: 2.2, fill: { color: "1E3A5F" }, rectRadius: 0.08
});
...
slide.addText("Use of Funds", {
  x: 0.8, y: 3.7, w: 3, h: 0.4, fontSize: 14, fontFace: "Calibri", bold: true, color: C.white
});
slide.addText([
...
slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
  x: 0.8, y: 1.2, w: 8.4, h: 3.8, fill: { color: C.white }, rectRadius: 0.08, shadow: makeShadow()
});
const whyMe = [
...
slide.addText("Include or exclude the following slides based on audience depth.", {
  x: 0.8, y: 3.4, w: 8.4, h: 0.4,
  fontSize: 12, fontFace: "Calibri", italic: true, color: C.medGray, align: "center"
});
...
demoMetrics.forEach(([num, label], i) => {
  const col = i * 2.3 + 0.8;
  slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
    x: col, y: 1.3, w: 2.1, h: 1.4, fill: { color: C.white }, rectRadius: 0.06, shadow: makeShadow()
  });
  slide.addText(num, {
    x: col, y: 1.4, w: 2.1, h: 0.55,
...
slide.addText("Key Communities in Trade Area:", {
  x: 0.8, y: 2.9, w: 8, h: 0.35, fontSize: 12, fontFace: "Calibri", bold: true, color: C.navy
});
const communities = [
...
slide.addTable(
  ...
  { x: 0.8, y: 3.3, w: 8.4, h: 1.8, fontFace: "Calibri", fontSize: 11, colW: [3.0, 5.4], border: { type: "solid", pt: 0.5, color: "E2E8F0" }, valign: "middle" }
);
slide.addNotes("OPTIONAL. Data sources: Census ACS, Fort Belvoir Wikipedia (verified 51K+ employees, $97K HHI).");
...
slide.addTable(
  ...
  { x: 0.8, y: 1.0, w: 8.4, h: 3.0, fontFace: "Calibri", fontSize: 10, colW: [2.5, 1.8, 1.5, 2.6], border: { type: "solid", pt: 0.5, color: "E2E8F0" }, valign: "middle" }
);
slide.addText([
...
], { x: 0.8, y: 4.2, w: 8.4, h: 0.7, fontSize: 12, fontFace: "Calibri", color: C.dark });
...
marketData.forEach(([num, label], i) => {
  const col = i * 2.3 + 0.8;
  slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
    x: col, y: 1.1, w: 2.1, h: 1.4, fill: { color: C.white }, rectRadius: 0.06, shadow: makeShadow()
  });
  slide.addText(num, {
    x: col, y: 1.2, w: 2.1, h: 0.55,
    fontSize: 20, fontFace: "Calibri", bold: true, color: C.green, align: "center"
  });
  slide.addText(label, {
    x: col, y: 1.75, w: 2.1, h: 0.6,
    fontSize: 10, fontFace: "Calibri", color: C.navy, align: "center"
  });
});
slide.addText("Industry Tailwinds:", {
  x: 0.8, y: 2.7, w: 8, h: 0.4, fontSize: 14, fontFace: "Calibri", bold: true, color: C.navy
});
slide.addText([
  ...
  { text: "AI/data personalization is the next frontier — nobody doing this at scale yet", options: { bullet: true, breakLine: true } },
  { text: "DC metro is top-5 market for golf technology adoption", options: { bullet: true } }
], { x: 0.8, y: 3.1, w: 8.5, h: 1.8, fontSize: 12, fontFace: "Calibri", color: C.dark, paraSpaceAfter: 6 });
slide.addNotes("OPTIONAL. Market sizing data. Key message: growing market, DC metro overindexes for golf tech, nobody combining AI + golf improvement yet.");
...
slide.addText("* Year 3+: Founder transitions to full-time CEO. Household reflects business income only (spouse income not shown).", {
  x: 0.5, y: 4.1, w: 9.0, h: 0.35, fontSize: 9, fontFace: "Calibri", italic: true, color: C.gray
});
slide.addText("Key Assumptions: $55/hr rate, 12 hrs/day, 360 days/yr, 20% ancillary revenue (memberships, events, lessons)", {
  x: 0.5, y: 4.45, w: 9.0, h: 0.3, fontSize: 9, fontFace: "Calibri", italic: true, color: C.gray
});
...
slide.addText("Budget Details:", {
  x: 5.3, y: 1.1, w: 4, h: 0.4, fontSize: 13, fontFace: "Calibri", bold: true, color: C.navy
});
const costs = [
...
slide.addText("Total: $150,000", {
  x: 5.3, y: 4.9, w: 3.7, h: 0.4, fontSize: 14, fontFace: "Calibri", bold: true, color: C.navy
});
...
belvoirStats.forEach(([num, label], i) => {
  const col = i * 2.3 + 0.8;
  slide.addShape(pres.shapes.ROUNDED_RECTANGLE, {
    x: col, y: 1.1, w: 2.1, h: 1.3, fill: { color: C.lightGray }, rectRadius: 0.06
  });
  slide.addText(num, {
    x: col, y: 1.2, w: 2.1, h: 0.5,
    fontSize: 18, fontFace: "Calibri", bold: true, color: C.navy, align: "center"
  });
  slide.addText(label, {
    x: col, y: 1.7, w: 2.1, h: 0.55,
    fontSize: 10, fontFace: "Calibri", color: C.gray, align: "center"
  });
});
slide.addText("Why Military Families Are Our Market:", {
  x: 0.8, y: 2.7, w: 8, h: 0.35, fontSize: 13, fontFace: "Calibri", bold: true, color: C.navy
});
slide.addText([
  ...
  { text: "MWR programs drive off-base activity spending", options: { bullet: true, breakLine: true } },
...
], { x: 0.8, y: 3.1, w: 8.5, h: 2.0, fontSize: 12, fontFace: "Calibri", color: C.dark, paraSpaceAfter: 5 });
...
slide.addNotes("Closing slide. Thank them for their time, open for questions.");
